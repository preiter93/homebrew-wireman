# homebrew-wireman
```
curl -LO https://github.com/preiter93/wireman/archive/refs/tags/v0.1.4.tar.gz
...
curl -LO https://github.com/preiter93/wireman/releases/download/v0.1.4/wireman-0.1.4-i686-unknown-linux-gnu.tar.gz
...
shasum -a 256 wireman-0.1.4-i686-unknown-linux-gnu.tar.gz
